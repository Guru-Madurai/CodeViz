      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-2xl font-extrabold text-slate-100">Big-O & Memory Calculator Tools</h1>
          </div>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-6">
          <div className="flex items-center justify-between border-b border-slate-800 pb-3">
            <h2 className="text-lg font-bold text-slate-100 flex items-center gap-2">
              <Calculator className="w-5 h-5 text-indigo-400" /> Big-O Complexity Calculator
            </h2>
            <span className="text-xs font-mono text-indigo-400">N = {arraySize.toLocaleString()} elements</span>
          </div>

          <div className="space-y-2">
            <label className="text-xs font-mono text-slate-400">Adjust Input Size (N):</label>
            <input
              type="range"
              min={10}
              max={10000}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4 font-mono text-xs">
            <div className="bg-slate-950 border border-emerald-500/30 p-4 rounded-xl space-y-1">
              <div className="text-emerald-400 font-bold">O(1) - Constant</div>
              <div className="text-xl font-bold text-slate-100">{o1} op</div>
            ...
            <div className="bg-slate-950 border border-indigo-500/30 p-4 rounded-xl space-y-1">
              <div className="text-indigo-400 font-bold">O(log N) - Logarithmic</div>
              <div className="text-xl font-bold text-slate-100">{oLogn} ops</div>
            ...
            <div className="bg-slate-950 border border-blue-500/30 p-4 rounded-xl space-y-1">
              <div className="text-blue-400 font-bold">O(N) - Linear</div>
              <div className="text-xl font-bold text-slate-100">{on.toLocaleString()} ops</div>
              <p className="text-[10px] text-slate-500">Linear Search, Array Traversal</p>
            </div>

            <div className="bg-slate-950 border border-purple-500/30 p-4 rounded-xl space-y-1">
              <div className="text-purple-400 font-bold">O(N log N) - Log-Linear</div>
              <div className="text-xl font-bold text-slate-100">{onLogn.toLocaleString()} ops</div>
              <p className="text-[10px] text-slate-500">Merge Sort, Quick Sort</p>
            </div>

            <div className="bg-slate-950 border border-red-500/30 p-4 rounded-xl space-y-1">
              <div className="text-red-400 font-bold">O(N²) - Quadratic</div>
              <div className="text-xl font-bold text-slate-100">{on2.toLocaleString()} ops</div>
