...
export const HomeView: React.FC<HomeViewProps> = ({ setCurrentTab }) => {
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col items-center justify-between selection:bg-indigo-500 selection:text-white">
      ...
      <div className="absolute top-40 right-10 w-[400px] h-[300px] bg-purple-600/10 blur-[120px] pointer-events-none rounded-full" />
      ...
      <section className="relative w-full max-w-5xl mx-auto px-4 pt-16 pb-20 text-center flex flex-col items-center">
        ...
        <button
          ...
          id="hero-badge-btn"
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/30 text-indigo-300 text-xs sm:text-sm font-medium mb-8 hover:bg-indigo-500/20 hover:border-indigo-500/50 transition-all cursor-pointer shadow-lg shadow-indigo-500/10 group"
        >
        ...
        {/* Hero Title */}
        <h1 className="text-4xl sm:text-6xl md:text-7xl font-extrabold text-slate-100 tracking-tight leading-[1.1] mb-6 max-w-4xl">
        ...
        {/* Hero Subtitle */}
        <p className="text-base sm:text-lg md:text-xl text-slate-400 max-w-2xl leading-relaxed mb-10 font-normal">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 mb-16">
          ...
          <button
            ...
            className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-800 text-slate-300 hover:text-white font-medium text-sm sm:text-base transition-all"
          >
        ...
        <div className="w-full rounded-2xl bg-slate-900/90 border border-slate-800 shadow-2xl p-4 sm:p-6 text-left relative overflow-hidden backdrop-blur-xl group">
          <div className="flex items-center justify-between pb-4 border-b border-slate-800/80 mb-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-mono text-slate-400 ml-2 flex items-center gap-1.5">
                <Terminal className="w-3.5 h-3.5 text-indigo-400" /> fibonacci_memo.py — Live Execution Trace
              </span>
            </div>
            <div className="flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/80 font-mono text-xs text-slate-300 space-y-1 overflow-x-auto">
              ...
              <div className="text-purple-400">def <span className="text-blue-400">fibonacci</span>(n, memo=&#123;&#125;):</div>
              <div className="pl-4 text-slate-300">if n in memo: <span className="text-purple-400">return</span> memo[n]</div>
              <div className="pl-4 text-slate-300">if n &lt;= 1: <span className="text-purple-400">return</span> n</div>
              <div className="pl-4 bg-indigo-500/20 border-l-2 border-indigo-400 pl-3 py-0.5 rounded-r text-indigo-200 font-semibold">
                result = fibonacci(n - 1, memo) + fibonacci(n - 2, memo)
              </div>
              <div className="pl-4 text-slate-300">memo[n] = result</div>
              <div className="pl-4 text-slate-300"><span className="text-purple-400">return</span> result</div>
            </div>

            {/* Right: Live Call Stack & Heap Snapshot */}
            <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/80 text-xs space-y-3">
              <div className="flex items-center justify-between text-slate-400 border-b border-slate-800/60 pb-2">
                <span className="font-semibold text-slate-200 flex items-center gap-1.5">
                  <Workflow className="w-3.5 h-3.5 text-purple-400" /> Active Call Stack Frames
                </span>
                <span className="text-[10px] text-emerald-400 font-mono">3 Frames Allocated</span>
              </div>

              <div className="space-y-1.5 font-mono">
                <div className="bg-indigo-950/60 border border-indigo-500/40 p-2 rounded-lg flex items-center justify-between text-indigo-200">
                  <span>fibonacci(n=2)</span>
                  <span className="text-[10px] bg-indigo-500/20 px-1.5 py-0.5 rounded">Line 8</span>
                </div>
                <div className="bg-slate-900 border border-slate-800 p-2 rounded-lg flex items-center justify-between text-slate-400">
                  <span>fibonacci(n=3)</span>
                  <span className="text-[10px] text-slate-500">Line 8</span>
                </div>
                <div className="bg-slate-900/60 border border-slate-800/60 p-2 rounded-lg flex items-center justify-between text-slate-500">
                  <span>&lt;module&gt;</span>
              ...
              <div className="pt-2 border-t border-slate-800/60 flex items-center justify-between text-[11px]">
                <span className="text-slate-400">Heap Memo Dict:</span>
          ...
          <div className="mt-4 pt-3 border-t border-slate-800/80 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
            <p className="text-slate-400 flex items-center gap-1.5">
              <Sparkles className="w-3.5 h-3.5 text-amber-400" /> Try custom Python, JavaScript, C++, or Java code in our full debugger!
            </p>
            <button
              onClick={() => setCurrentTab('playground')}
      ...
      <section className="w-full bg-slate-900/50 border-y border-slate-800/80 py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div
              onClick={() => setCurrentTab('playground')}
              className="p-6 rounded-2xl bg-slate-900 border border-slate-800 hover:border-indigo-500/50 hover:bg-slate-800/60 transition-all cursor-pointer group"
            >
            ...
            <div
              onClick={() => setCurrentTab('data-structures')}
              className="p-6 rounded-2xl bg-slate-900 border border-slate-800 hover:border-purple-500/50 hover:bg-slate-800/60 transition-all cursor-pointer group"
            >
            ...
            <div
              ...
              className="p-6 rounded-2xl bg-slate-900 border border-slate-800 hover:border-pink-500/50 hover:bg-slate-800/60 transition-all cursor-pointer group"
            >
              <div className="p-3 rounded-xl bg-pink-500/10 border border-pink-500/20 text-pink-400 w-fit mb-4 group-hover:scale-110 transition-transform">
                <Cpu className="w-6 h-6" />
              </div>
              <h3 className="text-lg font-bold text-slate-100 mb-2 group-hover:text-pink-300 transition-colors">
                Algorithms & Sorting
              </h3>
              <p className="text-slate-400 text-xs leading-relaxed">
            ...
            <div
              ...
              className="p-6 rounded-2xl bg-slate-900 border border-slate-800 hover:border-emerald-500/50 hover:bg-slate-800/60 transition-all cursor-pointer group"
            >
            ...
            <div
              onClick={() => setCurrentTab('playground')}
              className="p-6 rounded-2xl bg-slate-900 border border-slate-800 hover:border-amber-500/50 hover:bg-slate-800/60 transition-all cursor-pointer group"
            >
              ...
              <h3 className="text-lg font-bold text-slate-100 mb-2 group-hover:text-amber-300 transition-colors">
            ...
            <div
              ...
              className="p-6 rounded-2xl bg-slate-900 border border-slate-800 hover:border-blue-500/50 hover:bg-slate-800/60 transition-all cursor-pointer group"
            >
              ...
              <p className="text-slate-400 text-xs leading-relaxed">
                Test your code execution intuition with interactive stack depth quizzes, memory leak spotters, and pointer puzzles.
              </p>
            </div>
          </div>
        </div>
